...
//        });
        ...
        tmpTL.add("2015-11-8");
        tmpTL.add("2015-11-9");
        tmpTL.add("2015-11-10");
        tmpTL.add("2015-11-11");
//        DPCManager.getInstance().setDecorTL(tmpTL);

        List<String> tmpTR = new ArrayList<>();
        tmpTR.add("2015-11-10");
        tmpTR.add("2015-11-11");
        tmpTR.add("2015-11-12");
        tmpTR.add("2015-11-13");
        tmpTR.add("2015-11-14");
        tmpTR.add("2015-11-15");
        tmpTR.add("2015-11-16");
...
//        });
        ...
        // 对话框下的DatePicker示例 Example in dialog
        Button btnDialog = (Button) findViewById(R.id.main_dialog_btn);
