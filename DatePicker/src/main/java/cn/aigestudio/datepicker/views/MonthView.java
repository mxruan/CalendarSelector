...
public class MonthView extends View {
    ...
    private void setIntercept(boolean intercept){
        if (mView!=null){
            mView.requestDisallowInterceptTouchEvent(intercept);
        }
    }
...
//        setMeasuredDimension(measureWidth, (int) (measureWidth * 6F / 7F));
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        circleRadius = (int) (cellW/1.5);

        animZoomOut1 = (int) (circleRadius * 1.2F);
        animZoomIn1 = (int) (circleRadius * 0.8F);
        animZoomOut2 = (int) (circleRadius * 1.1F);
